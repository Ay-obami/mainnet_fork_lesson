...
// Commit sha:  55f30d4
// Repo URL:  https://github.com/Ay-obami/mainnet_fork_lesson
...
contract Submission {
    ...
    function swapUsdtForWeth(uint256 amountIn, uint256 amountOutMin, address recipient, uint256 deadline)
        external
        returns (uint256 amountOut)
    {
        ...
        uint256[] memory amounts =
            IUniswapV2Router02(ROUTER).swapExactTokensForTokens(amountIn, amountOutMin, path, recipient, deadline);
    ...
    function addUsdtWethLiquidity(
        ...
        address recipient,
        uint256 deadline
    ) external returns (uint256 usdtUsed, uint256 wethUsed, uint256 liquidity) {
        ...
        (usdtUsed, wethUsed, liquidity) = IUniswapV2Router02(ROUTER)
            .addLiquidity(USDT, WETH, usdtDesired, wethDesired, usdtMin, wethMin, recipient, deadline);
